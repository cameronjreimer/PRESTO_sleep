...
var_label(data$exercise) <- "Hours of exercise / week"
# Assign variables for table one 
myVars <- c("ageatqstn", "race_ethnic_factors", "educ_factors", "income_factors", "ct_HHinc", "ct_lths", "ct_urban_cat", "b_hourssleep", "exercise", "b_currentjob", "b_jobhrsperweek")
catVars <- c( "race_ethnic_factors", "educ_factors",  "income_factors", "ct_urban_cat", "b_currentjob")
```
