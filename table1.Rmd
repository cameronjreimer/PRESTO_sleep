...
myVars <- c("ageatqstn", "race_ethnic_factors", "educ_factors", "income_factors", "ct_HHinc", "ct_lths", "ct_urban_cat", "b_hourssleep", "b_currentjob", "b_jobhrsperweek", "b_totalmet", "hrssleep_cat")
