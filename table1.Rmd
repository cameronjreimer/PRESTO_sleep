...
myVars <- c("ageatqstn", "race_ethnic_factors", "educ_factors", "income_factors", "ct_HHinc", "ct_lths", "ct_urban_cat", "b_hourssleep", "exercise", "b_currentjob", "b_jobhrsperweek", "hrssleep_cat")
...
#var_label(dropped$exercise) <- "Hours of exercise / week"
